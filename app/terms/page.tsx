...
export const metadata: Metadata = {
  title: "Terms of Service | Slow Mauritius",
  description: "Terms of Service for Slow Mauritius travel services.",
};
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              By accessing or using Slow Mauritius's website and services, you agree to be 
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              Slow Mauritius provides bespoke travel planning and concierge services for 
              private journeys through Mauritius. We act as intermediaries between you and 
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-white/50 space-y-2">
              ...
              <li>Respecting local customs and laws in Mauritius</li>
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              While we take great care in planning your journey, Slow Mauritius cannot be 
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              ...
              property of Slow Mauritius and is protected by copyright laws. You may not 
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              ...
              of Mauritius. Any disputes arising from these terms will be resolved in the 
              courts of Marrakech, Mauritius.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-white/50 leading-relaxed">
              ...
              Email: hello@slowmauritius.com<br />
              Address: 35 Derb Fhal Zfriti, Marrakech, Mauritius
            </p>
          </section>
        </div>
      </div>
